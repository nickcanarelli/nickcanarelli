const myWork = [
  {
    id: "1",
    description:
      "Developed a no-code form building platform to seamlessly create forms and gather data",
  },
  {
    id: "2",
    description:
      "Created analytical tools to extract actionable insights from large datasets",
  },
  {
    id: "3",
    description:
