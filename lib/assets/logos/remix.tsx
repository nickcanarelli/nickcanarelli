...
type TRemixLogo = ComponentPropsWithoutRef<'svg'>

const RemixLogo = forwardRef<SVGSVGElement, TRemixLogo>(({ className, ...props }, ref) => {
  return (
    <svg
      ref={ref}
...
export { RemixLogo as default, type TRemixLogo }
