...
type TAWSLogo = ComponentPropsWithoutRef<'svg'>

const AWSLogo = forwardRef<SVGSVGElement, TAWSLogo>(({ className, ...props }, ref) => {
  return (
    <svg
      ref={ref}
...
export { AWSLogo as default, type TAWSLogo }
