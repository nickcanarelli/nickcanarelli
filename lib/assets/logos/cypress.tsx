...
type TCypressLogo = ComponentPropsWithoutRef<'svg'>

const CypressLogo = forwardRef<SVGSVGElement, TCypressLogo>(({ className, ...props }, ref) => {
  return (
    <svg
      ref={ref}
...
export { CypressLogo as default, type TCypressLogo }
