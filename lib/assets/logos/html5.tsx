...
type THTML5Logo = ComponentPropsWithoutRef<'svg'>

const HTML5Logo = forwardRef<SVGSVGElement, THTML5Logo>(({ className, ...props }, ref) => {
  return (
    <svg
      ref={ref}
...
export { HTML5Logo as default, type THTML5Logo }
