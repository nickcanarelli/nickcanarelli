...
type TPrettierLogo = ComponentPropsWithoutRef<'svg'>

const PrettierLogo = forwardRef<SVGSVGElement, TPrettierLogo>(({ className, ...props }, ref) => {
  return (
    <svg
      ref={ref}
...
export { PrettierLogo as default, type TPrettierLogo }
