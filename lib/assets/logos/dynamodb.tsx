...
type TDynamoDBLogo = ComponentPropsWithoutRef<'svg'>

const DynamoDBLogo = forwardRef<SVGSVGElement, TDynamoDBLogo>(({ className, ...props }, ref) => {
  return (
    <svg
      ref={ref}
...
export { DynamoDBLogo as default, type TDynamoDBLogo }
