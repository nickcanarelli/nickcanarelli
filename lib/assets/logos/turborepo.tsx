...
type TTurborepoLogo = ComponentPropsWithoutRef<'svg'>

const TurborepoLogo = forwardRef<SVGSVGElement, TTurborepoLogo>(({ className, ...props }, ref) => {
  return (
    <svg
      ref={ref}
    ...
    >
      <defs>
        ...
        <linearGradient x1='11.4859916%' y1='-2.19377472%' x2='11.4859916%' y2='512.39779%' id='b'>
          <stop stopColor='#1E90FF' offset='0%' />
          <stop stopColor='#FF1E56' offset='100%' />
        </linearGradient>
        <linearGradient
        ...
        <linearGradient x1='11.4859916%' y1='-412.397334%' x2='11.4859916%' y2='102.193662%' id='e'>
          <stop stopColor='#1E90FF' offset='0%' />
          <stop stopColor='#FF1E56' offset='100%' />
        </linearGradient>
        <linearGradient x1='123.779228%' y1='-598.960854%' x2='123.779228%' y2='99.9997513%' id='f'>
          <stop stopColor='#1E90FF' offset='0%' />
          <stop stopColor='#FF1E56' offset='100%' />
        </linearGradient>
      </defs>
...
export { TurborepoLogo as default, type TTurborepoLogo }
