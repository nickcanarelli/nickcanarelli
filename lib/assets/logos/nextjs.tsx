...
type TNextJSLogo = ComponentPropsWithoutRef<'svg'>

const NextJSLogo = forwardRef<SVGSVGElement, TNextJSLogo>(({ className, ...props }, ref) => {
  return (
    <svg
      ref={ref}
...
export { NextJSLogo as default, type TNextJSLogo }
